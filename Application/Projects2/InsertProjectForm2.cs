...
namespace SKC
{
    public partial class InsertProjectForm2 : Form
    {
        public InsertProjectForm2()
        {
            InitializeComponent();
        }
        ...
        {
            newProject.Place = comboBoxPlace.Text;
            newProject.Bush = comboBoxBush.Text;
            newProject.Well = comboBoxWell.Text;
            newProject.Job = textBoxJob.Text;
